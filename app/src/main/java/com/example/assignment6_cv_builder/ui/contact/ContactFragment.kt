package com.example.assignment6_cv_builder.ui.contact
...
import com.example.assignment6_cv_builder.MyWebActivity
...
class ContactFragment : Fragment(R.layout.fragment_contact), OnClickListener {
    ...
    private fun onMobileClicked() {
        val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+16418192242"))
