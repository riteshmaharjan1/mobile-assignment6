package com.example.assignment6_cv_builder
...
import com.example.assignment6_cv_builder.constants.Constant.IS_LOGGED_IN
import com.example.assignment6_cv_builder.constants.Constant.SHARED_PREF_NAME
...
import com.example.assignment6_cv_builder.constants.Constant.USER_PASSWORD
...
class LoginActivity : AppCompatActivity(), OnClickListener {
    ...
    private fun initSharedPreference() {
        ...
        editor.putString(USER_EMAIL, "riteshmaharjan@miu.edu")
        editor.putString(USER_PASSWORD, "ritesh")
        editor.putString(USER_NAME, "Ritesh Maharfjan")
